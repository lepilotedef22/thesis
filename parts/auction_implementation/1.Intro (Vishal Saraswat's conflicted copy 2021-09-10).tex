...
% Can we have a manager/trusted party who can see everything? Do we want
% the public validation of auction outcome by participants only or
% anyone can verify it? Do we have exactly the same requirements for all
% the use cases? If no, which use case is the priority?
...
% \textcolor{red}{Vishal et al. paper
%   improvement-Blockchain+auditing+zkproof}

% \textcolor{red}{Galal's paper improvement-Signer's anonymity}

% \textcolor{red}{Assumption-Blockchain facilitates anonymous and
